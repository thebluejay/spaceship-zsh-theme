...
# MERCURIAL BRANCH
SPACESHIP_HG_BRANCH_SHOW="${SPACESHIP_HG_BRANCH_SHOW:=false}"
...
# MERCURIAL STATUS
SPACESHIP_HG_STATUS_SHOW="${SPACESHIP_HG_STATUS_SHOW:=false}"
...
SPACESHIP_EMBER_COLOR="${SPACESHIP_EMBER_COLOR:="202"}"
